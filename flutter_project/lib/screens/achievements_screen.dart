...
class AchievementsScreen extends StatelessWidget {
  ...
  static const List<Map<String, dynamic>> _allAchievements = [
    ...
    },
    {
      'id': 'subitizador',
      'title': 'Subitizador',
      'description': 'Reconoce puntos sin contar',
      'emoji': '🎯',
      'gradient': [Color(0xFF1565C0), Color(0xFF42A5F5)],
    },
    {
      'id': 'explorador_numerico',
      'title': 'Explorador numérico',
      'description': 'Ubica números en la línea',
      'emoji': '🗺️',
      'gradient': [Color(0xFF2E7D32), Color(0xFF66BB6A)],
    },
    {
      'id': 'maestro_partes',
      'title': 'Maestro de partes',
      'description': 'Descompone números perfecto',
      'emoji': '🧩',
      'gradient': [Color(0xFF6A1B9A), Color(0xFFAB47BC)],
    },
    {
      'id': 'artista_numeros',
      'title': 'Artista de números',
      'description': 'Traza todos los números bien',
      'emoji': '✏️',
      'gradient': [Color(0xFF00838F), Color(0xFF26C6DA)],
    },
    {
      'id': 'maestro_resta',
      'title': 'Maestro de resta',
      'description': 'Resta sin ningún error',
      'emoji': '➖',
      'gradient': [Color(0xFFC62828), Color(0xFFEF5350)],
    },
    {
