...
DIAGNOSTICO_PREGUNTAS = [
    # ── 1. Reconocimiento de números ─────────────────────────────────────────
    {
        ...
        "texto": "¿Cuál es este número?",
        "emoji": "7️⃣",
        "audio": "¿Cuál es este número?",
        "opciones": ["1", "4", "7", "9"],
        "correcta": "7",
        "indicador": "reconocimiento_numeros",
    },
    {
        "id": 2,
        "categoria": "reconocimiento",
        ...
        "emoji": "4️⃣  vs  9️⃣",
        "audio": "¿Cuál número es mayor, el cuatro o el nueve?",
        "opciones": ["4", "9", "Son iguales", "No sé"],
        "correcta": "9",
        "indicador": "reconocimiento_numeros",
    },
    {
        "id": 3,
        "categoria": "reconocimiento",
        "texto": "Ordena de menor a mayor: 3, 8 y 5",
        "emoji": "3️⃣  8️⃣  5️⃣",
        "audio": "Ordena estos números de menor a mayor: tres, ocho y cinco",
        "opciones": ["3, 5, 8", "3, 8, 5", "5, 3, 8", "8, 5, 3"],
        "correcta": "3, 5, 8",
        "indicador": "reconocimiento_numeros",
    },
    # ── 2. Conteo ─────────────────────────────────────────────────────────────
    {
        "id": 4,
        "categoria": "conteo",
        "texto": "¿Cuántas manzanas hay?",
        "emoji": "🍎🍎🍎🍎🍎🍎",
        "audio": "Cuenta las manzanas. ¿Cuántas hay?",
        "opciones": ["4", "5", "6", "7"],
        "correcta": "6",
        "indicador": "conteo",
    },
    {
        "id": 5,
        "categoria": "conteo",
        "texto": "10, 9, 8, __, 6 — ¿Qué número falta?",
        "emoji": "🔢",
        "audio": "Diez, nueve, ocho, ¿qué número sigue?, seis",
        "opciones": ["5", "6", "7", "8"],
        "correcta": "7",
        "indicador": "conteo",
    },
    # ── 3. Comparación de cantidades ──────────────────────────────────────────
    {
        ...
        "texto": "¿Cuál grupo tiene MÁS estrellas?",
        "emoji": "⭐⭐⭐  vs  ⭐⭐⭐⭐⭐",
        "audio": "¿Cuál grupo tiene más estrellas? El grupo A tiene tres y el grupo B tiene cinco",
        "opciones": ["Grupo A (3)", "Grupo B (5)", "Son iguales", "No sé"],
        "correcta": "Grupo B (5)",
        "indicador": "comparacion_cantidades",
    },
    {
        "id": 7,
        "categoria": "comparacion",
        "texto": "¿Cuál grupo tiene MENOS frutas?",
        "emoji": "🍊🍊🍊🍊  vs  🍊🍊",
        "audio": "¿Cuál grupo tiene menos frutas? El grupo A tiene cuatro y el grupo B tiene dos",
        "opciones": ["Grupo A (4)", "Grupo B (2)", "Son iguales", "No sé"],
        "correcta": "Grupo B (2)",
        "indicador": "comparacion_cantidades",
    },
    # ── 4. Operaciones básicas — Sumas ────────────────────────────────────────
    {
        "id": 8,
        "categoria": "operaciones",
        "texto": "2 + 3 = ?",
        "emoji": "🍎🍎 + 🍎🍎🍎",
        "audio": "¿Cuánto es dos más tres?",
        "opciones": ["4", "5", "6", "7"],
        "correcta": "5",
        "indicador": "operaciones_basicas",
    },
    {
        "id": 9,
        "categoria": "operaciones",
        "texto": "5 + 4 = ?",
        "emoji": "⭐⭐⭐⭐⭐ + ⭐⭐⭐⭐",
        "audio": "¿Cuánto es cinco más cuatro?",
        "opciones": ["7", "8", "9", "10"],
        "correcta": "9",
        "indicador": "operaciones_basicas",
    },
    # ── 4. Operaciones básicas — Restas ───────────────────────────────────────
    {
        "id": 10,
        "categoria": "operaciones",
        "texto": "7 - 2 = ?",
        "emoji": "🌟🌟🌟🌟🌟🌟🌟 − 🌟🌟",
        "audio": "¿Cuánto es siete menos dos?",
        "opciones": ["3", "4", "5", "6"],
        "correcta": "5",
        "indicador": "operaciones_basicas",
    },
    {
        ...
        "texto": "9 - 4 = ?",
        "emoji": "🍕🍕🍕🍕🍕🍕🍕🍕🍕 − 🍕🍕🍕🍕",
        "audio": "¿Cuánto es nueve menos cuatro?",
        "opciones": ["3", "4", "5", "6"],
        "correcta": "5",
        "indicador": "operaciones_basicas",
    },
    # ── 5. Secuencias numéricas ───────────────────────────────────────────────
    {
        ...
        "texto": "1, 2, 3, __, 5 — ¿Qué número falta?",
        "emoji": "1️⃣ 2️⃣ 3️⃣ ❓ 5️⃣",
        "audio": "Uno, dos, tres, ¿qué número falta?, cinco",
        "opciones": ["2", "3", "4", "6"],
        "correcta": "4",
        "indicador": "secuencias_numericas",
    },
    {
        "id": 13,
        "categoria": "secuencias",
        "texto": "10, 9, 8, __, 6 — ¿Qué número falta?",
        "emoji": "🔟 9️⃣ 8️⃣ ❓ 6️⃣",
        "audio": "Diez, nueve, ocho, ¿qué número falta?, seis",
        "opciones": ["5", "6", "7", "8"],
        "correcta": "7",
        "indicador": "secuencias_numericas",
    },
    # ── 6. Relación número-cantidad ───────────────────────────────────────────
    {
        "id": 14,
        "categoria": "relacion_cantidad",
        "texto": "¿Cuál imagen tiene exactamente 4 objetos?",
        "emoji": "A:🐱🐱🐱  B:🐱🐱🐱🐱  C:🐱🐱🐱🐱🐱",
        "audio": "¿Cuál imagen tiene exactamente cuatro objetos?",
        "opciones": ["A (3 objetos)", "B (4 objetos)", "C (5 objetos)", "No sé"],
        "correcta": "B (4 objetos)",
        "indicador": "relacion_numero_cantidad",
    },
    {
        "id": 15,
        "categoria": "relacion_cantidad",
        "texto": "¿Cuántas estrellas ves? Elige el número.",
        "emoji": "⭐⭐⭐⭐⭐⭐⭐⭐",
        "audio": "Cuenta las estrellas y elige el número correcto",
        "opciones": ["6", "7", "8", "9"],
        "correcta": "8",
        "indicador": "relacion_numero_cantidad",
    },
